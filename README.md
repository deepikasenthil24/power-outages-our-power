...
Index| MONTH | NERC.REGION | CLIMATE.CATEGORY | OUTAGE.START.DATE | ... | PCT_WATER_TOT | OUTAGE.START | OUTAGE.RESTORATION | robust |
|------|------|------|------|------|------|------|------|------|-------|
